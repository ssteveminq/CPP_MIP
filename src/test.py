...
if __name__ == '__main__':
    ...
    reso = 2.0
    goal_x, goal_y, gmap, covmap = planning(ox, oy, reso)    #waypoint geneneration
    #test for grid map
    ...
    if args.obs == None or args.obs==0:
        ...
        obs_coords = [[-0.5, 0.5, 0, 2.5], [-3.5, -2, -1, 2]]     # array containing all obstacles in [x_min,x_max,y_min,y_max] format
    ...
    if args.obs == 1:
        ...
        f_max = [0.25]      # maximum force experienced by a vehicle
        T = 100             # maximum time of travel
        dt = 4.             # time step size
        ...
        veh_coords = [[5, 5, -3.5, 6]]    # array containing all vehicles in [x_0,y_0,x_fin,y_fin] format
