...
def calc_states_list():
    # maxyaw = math.radians(-120.0)
    maxyaw = np.deg2rad(20.0)
    x = np.arange(-4.0, 8.0, 4.0)
    y = np.arange(-2.0, 4.0, 2.0)
    # x = np.arange(-15, 15.0, 1.5)
    # y = np.arange(-15.0, 15.0, 1.5)
    # x = np.arange(-10.0, 20.0, 5.0)
    # y = np.arange(0.0, 20.0, 2.0)
    yaw = np.arange(-maxyaw, 1.5*maxyaw, maxyaw/2)
    # print("x", x)
    print("yaw", yaw)
